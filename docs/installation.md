...
## Package Control
The recommended way to install TabsExtra is via [Package Control](https://packagecontrol.io/).  Package Control will install the correct branch on your system and keep it up to date.
...
!!! warning "Warning"
    This is not the recommended way to install TabsExtra for the casual user as it requires the user to know which branch to install, know how to use git, and **will not** get automatically updated.
